...
RUN apt-get -y update && apt-get -y install maven && apt-get -y install wget
...
ADD https://archive.apache.org/dist/tomcat/tomcat-8/v8.5.33/bin/apache-tomcat-8.5.33.tar.gz  /tmp/tomcat.tar.gz
